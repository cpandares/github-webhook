...
// and asserts the results of JSON.parse at runtime
 class Convert {
    public static toGithubIssuePayload(json: string): GithubIssuePayload {
        return cast(JSON.parse(json), r("GithubIssuePayload"));
    }

    public static githubIssuePayloadToJson(value: GithubIssuePayload): string {
        return JSON.stringify(uncast(value, r("GithubIssuePayload")), null, 2);
    }
}
...
const typeMap: any = {
    "GithubIssuePayload": o([
        { json: "action", js: "action", typ: "" },
        { json: "issue", js: "issue", typ: r("Issue") },
    ...
    "Issue": o([
        ...
        { json: "user", js: "user", typ: r("Sender") },
        ...
        { json: "active_lock_reason", js: "active_lock_reason", typ: null },
        { json: "body", js: "body", typ: null },
        { json: "reactions", js: "reactions", typ: r("Reactions") },
        { json: "timeline_url", js: "timeline_url", typ: "" },
        { json: "performed_via_github_app", js: "performed_via_github_app", typ: null },
