...
// and asserts the results of JSON.parse at runtime
 class Convert {
    public static toGitHubStar(json: string): GitHubStarPayload {
        return cast(JSON.parse(json), r("GitHubStar"));
    }

    public static gitHubStarToJson(value: GitHubStarPayload): string {
        return JSON.stringify(uncast(value, r("GitHubStar")), null, 2);
    }
}
